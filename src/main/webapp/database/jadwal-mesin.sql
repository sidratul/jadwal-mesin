...
CREATE TABLE `JADWAL` (
  ...
  `Hari` smallint(6) DEFAULT NULL COMMENT '0 = minggu,\n1 = senin,\n2 = selasa,\n3 = rabu\n4 = kamis\n5 = jumat\n6 = sabtu',
  `Keterangan` enum('0','1','2','3','4','5') DEFAULT NULL COMMENT '0 = - ,\n 1 = hadir ,\n 2 = izin ,\n 3 = absen ,\n 4 = tugas ,\n 5 = Sakit',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_Matakuliah` (`ID_Matakuliah`),
  KEY `JADWAL_ibfk_2` (`ID_Dosen`),
  CONSTRAINT `JADWAL_ibfk_1` FOREIGN KEY (`ID_Matakuliah`) REFERENCES `MATAKULIAH` (`ID`),
...
INSERT INTO `JADWAL` VALUES (9,2,7,NULL,1,NULL);
...
-- Dump completed on 2013-09-24 15:40:26
